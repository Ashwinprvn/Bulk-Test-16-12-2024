...
<div className="flex flex-col w-screen mt-10">
        <div className="flex flex-row justify-evenly">
          ...
          <div className="ml-2">
            <h1 className="font-tafel text-blue-900 text-xxs">INCREDIENTS</h1>
            <h1 className="font-tafel text-black text-sm truncate">Better Incredients</h1>
          ...
          <div className="w-[110px] h-[70px] bg-[url('/vitamin-c.png')] bg-cover bg-center rounded-lg flex-col justify-between ">
            <div>
              <h1 className="font-tafel text-black text-xxs mt-2 truncate ml-1">Vitamin C</h1>
          ...
          <div className="w-[110px] h-[70px] bg-[url('/bn2-2.jpg.png')] bg-cover bg-center rounded-lg flex-col justify-between">
            <div>
              <h1 className="font-tafel text-black text-xxs mt-2 truncate ml-1">Vitamin B3</h1>
        ...
        <div className="w-[110px] h-[70px] bg-[url('/magnesium.png')] bg-cover bg-center rounded-lg flex-col justify-between">
            <div>
              <h1 className="font-tafel text-black text-xxs mt-2 truncate ml-1">Magnesium</h1>
           ...
           <div className="w-[110px] h-[70px] bg-[url('/hyaluronic.png')] bg-cover bg-center rounded-lg flex-col justify-between">
            <div>
              <h1 className="font-tafel text-black text-xxs mt-2 truncate ml-1">Hyaluronic Acid</h1>
          ...
          <div className="w-[110px] h-[70px] bg-[url('/lactobacilus.png')] bg-cover bg-center rounded-lg flex-col justify-between">
            <div>
              <h1 className="font-tafel text-black text-xxs mt-2 truncate ml-1">Lactobaculus</h1>
          ...
          <Image src="/color.png" height={40} width={40} alt="img" loading="lazy"/>
        </div>
      </div>
)
}
